        ...
        <div className="row">
          ...
          <div className="col-md-3 mb-4">
            ...
            <p className="text-muted small mb-4">
              Vietnam's leading platform for event networking and management.
              Providing a great experience for both organizers and attendees. 
            </p>
          ...
          <div className="col-md-3 mb-4 ps-md-5">
            ...
            <ul className="list-unstyled footer-list text-muted small">
              ...
              <li className="mb-2">Tech Seminars</li>
              <li className="mb-2">Marathon Races</li>
